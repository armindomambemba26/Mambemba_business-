...
(function () {
  ...
  orderForm.addEventListener("submit", function (e) {
    ...
    if (pendingPhotoDataUrls.length) {
      ...
      savePhoto(id, pendingPhotoDataUrls).then(function (ok) {
        if (ok) {
          toast("Fotos guardadas com sucesso.", "success");
        } else {
          delete photoCache[id];
          toast("A encomenda foi guardada, mas as fotos falharam ao enviar. Abra em Editar e tente novamente.", "error");
        }
      });
    } else {
