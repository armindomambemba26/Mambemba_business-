# MAMBEMBA BUSINESS — v3.4 (GitHub Pages + Firebase)
...
- **Encomendas:** criar, editar, pesquisar em tempo real, filtrar por estado, marcar como
  ...
  **agrupada por dia**, com cabeçalho de data e contagem de encomendas por dia. Cor,
  ...
  "Perfume".
- **Fotos do produto:** até 5 fotos por encomenda (útil quando o cliente pede vários
  produtos na mesma encomenda), selecionadas da galeria/câmara do telemóvel, com
  pré-visualização e possibilidade de remover cada uma antes de guardar. Guardadas no
  Firestore (comprimidas automaticamente), sincronizadas em qualquer dispositivo.
